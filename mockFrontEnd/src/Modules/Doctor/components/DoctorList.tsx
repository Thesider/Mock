                ...
                <div className={doctorStyles.emptyState}>
                    <div className={doctorStyles.emptyStateIcon}>
                        <svg width="48" height="48" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            {searchQuery ? (
                                <path d="M21 21L16.514 16.514M19 10.5C19 15.194 15.194 19 10.5 19S2 15.194 2 10.5 5.806 2 10.5 2 19 5.806 19 10.5Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                            ) : (
                            ...
                            {doctors.map((doctor) => (
                                <tr key={doctor.id} className={listStyles.tableRow}>
                                    ...
                                    {editingId === doctor.id ? (
                                        <>
                                            <td className={listStyles.tableCell}>
                                                <input
                                                    ...
                                                    className={doctorStyles.editInput + (editFormErrors.name ? ' ' + doctorStyles.editError : '')}
                                                    placeholder="Enter doctor's name"
                                                />
                                                {editFormErrors.name && (
                                                    <div className={doctorStyles.editErrorText}>{editFormErrors.name}</div>
                                                )}
                                            </td>
                                            <td className={listStyles.tableCell}>
                                                <input
                                                    ...
                                                    onChange={handleEditInputChange}
                                                    onBlur={handleEditInputBlur}
                                                    className={doctorStyles.editInput + (editFormErrors.specialty ? ' ' + doctorStyles.editError : '')}
                                                    placeholder='Specialty'
                                                />
                                                {editFormErrors.specialty && (
                                                    <div className={doctorStyles.editErrorText}>{editFormErrors.specialty}</div>
                                                )}
                                            </td>
                                            <td className={listStyles.tableCell}>
                                                <input
                                                    ...
                                                    onChange={handleEditInputChange}
                                                    onBlur={handleEditInputBlur}
                                                    className={doctorStyles.editInput + (editFormErrors.department ? ' ' + doctorStyles.editError : '')}
                                                    placeholder='Department'
                                                />
                                                {editFormErrors.department && (
                                                    <div className={doctorStyles.editErrorText}>{editFormErrors.department}</div>
                                                )}
                                            </td>
                                            <td className={listStyles.tableCell}>
                                                <input
                                                    ...
                                                    onChange={handleEditInputChange}
                                                    onBlur={handleEditInputBlur}
                                                    className={doctorStyles.editInput + (editFormErrors.phoneNumber ? ' ' + doctorStyles.editError : '')}
                                                    placeholder='Phone Number'
                                                />
                                                {editFormErrors.phoneNumber && (
                                                    <div className={doctorStyles.editErrorText}>{editFormErrors.phoneNumber}</div>
                                                )}
                                            </td>
                                            <td className={listStyles.tableCell}>
                                                <select
                                                    ...
                                                    onChange={handleEditInputChange}
                                                    onBlur={handleEditInputBlur}
                                                    className={doctorStyles.editSelect + (editFormErrors.status ? ' ' + doctorStyles.editError : '')}
                                                ...
                                                {editFormErrors.status && (
                                                    <div className={doctorStyles.editErrorText}>{editFormErrors.status}</div>
                                                )}
                                            </td>
                                            <td className={listStyles.tableCell}>
                                                <div className={doctorStyles.actionButtons}>
                                                    <button
                                                        ...
                                                        className={doctorStyles.button + ' ' + doctorStyles.buttonSuccess + ' ' + doctorStyles.iconButton}
                                                        title="Save changes"
                                                    >
                                                        <span className={doctorStyles.buttonIcon}>✓</span>
                                                        Save
                                                    ...
                                                    <button
                                                        ...
                                                        className={doctorStyles.button + ' ' + doctorStyles.buttonSecondary + ' ' + doctorStyles.iconButton}
                                        ...
                                        <>
                                            <td className={listStyles.tableCell + ' ' + listStyles.tableCellName}>
                                                {doctor.name}
                                            </td>
                                            <td className={listStyles.tableCell}>
                                                {doctor.specialty}
                                            ...
                                            <td className={listStyles.tableCell + ' ' + listStyles.tableCellPhone}>
                                            ...
                                            <td className={listStyles.tableCell}>
                                                <div className={doctorStyles.actionButtons}>
                                                    ...
                                                    <button
                                                        ...
                                                        className={doctorStyles.button + ' ' + doctorStyles.buttonDanger + ' ' + doctorStyles.iconButton}
                                                        title="Delete doctor"
                                                    >
                                                        <span className={doctorStyles.buttonIcon}>×</span>
                                                        Delete
