...
const DoctorList: React.FC<DoctorListProps> = ({
  ...
  const renderTableContent = () => {
    if (loading) {
      return (
        <tr>
          <td colSpan={7} className={listStyles.tableCell}>
            <div className={listStyles.tableStateContainer}>
              <div className={listStyles.tableStateContent}>
                <div className={listStyles.loadingSpinner}></div>
                <div className={listStyles.tableStateText}>Loading doctors...</div>
              </div>
            </div>
          </td>
        </tr>
      ...
      return (
        <tr>
          <td colSpan={7} className={listStyles.tableCell}>
            <div className={listStyles.tableStateContainer}>
              <div className={listStyles.tableStateContent}>
                <div className={listStyles.errorIcon}>⚠️</div>
                <div className={listStyles.tableStateTitle}>Error</div>
                <div className={listStyles.tableStateText}>{error}</div>
                {onRetry && (
                  <button
                    type="button"
                    onClick={onRetry}
                    className={`${doctorStyles.button} ${doctorStyles.buttonPrimary}`}
                  >
                    Retry
                  </button>
                )}
          ...
          <td colSpan={7} className={listStyles.tableCell}>
            <div className={listStyles.tableStateContainer}>
              <div className={listStyles.tableStateContent}>
                ...
                <div className={listStyles.tableStateTitle}>
                  {searchQuery ? "No doctors match your search" : "No doctors found"}
                </div>
                <div className={listStyles.tableStateText}>
                  {searchQuery
